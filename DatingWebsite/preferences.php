...
<!-- bradcam_area  -->
    ...
    <!--/ bradcam_ar-->
    <!-- slider_area_start --><!--page-wrapper p-t-130 p-b-100 font-poppins bg-gra-02-->
       ...
       <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                  ...
                  <form action="enter_preference.php" class="was-validated" method="post">
                            ...
                            <div class="col-lg-6">
                              <div class="input-group">
                                <!--<label class="label">Location</label> -->
                                    ...
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="location_pref_id" required>
